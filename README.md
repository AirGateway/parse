# Parse [![Build Status](https://travis-ci.org/AirGateway/parse.svg?branch=master)](https://travis-ci.org/AirGateway/parse) [![GoDoc](http://godoc.org/github.com/AirGateway/parse?status.svg)](http://godoc.org/github.com/AirGateway/parse) [![Coverage Status](https://coveralls.io/repos/github/AirGateway/parse/badge.svg?branch=master)](https://coveralls.io/github/AirGateway/parse?branch=master)
...
The lexers are implemented using `buffer.Lexer` in https://github.com/AirGateway/parse/buffer and the parsers work on top of the lexers. Some subpackages have hashes defined (using [Hasher](https://github.com/AirGateway/hasher)) that speed up common byte-slice comparisons.
...
[See README here](https://github.com/AirGateway/parse/tree/master/css).
...
[See README here](https://github.com/AirGateway/parse/tree/master/html).
...
[See README here](https://github.com/AirGateway/parse/tree/master/js).
...
[See README here](https://github.com/AirGateway/parse/tree/master/json).
...
[See README here](https://github.com/AirGateway/parse/tree/master/xml).
