# XML [![GoDoc](http://godoc.org/github.com/AirGateway/parse/xml?status.svg)](http://godoc.org/github.com/AirGateway/parse/xml)
...
Run the following command
	...
	go get -u github.com/AirGateway/parse/xml

or add the following import and run project with `go get`

	import "github.com/AirGateway/parse/xml"
